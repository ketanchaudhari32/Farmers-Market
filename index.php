    ...
    <nav class="navbar navbar-inverse navbar-fixed-top"style= "opacity: 0.7; filter:alpha (opacity =70);" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header"  >
              ...
              <a class="navbar-brand" href="index.php" style = "padding-right: 100px; font-size: 25px; "><strong>FarmersBasket.com</strong></a>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav"  >
					...
					<li>
                        <a href="login.php" style= "font-weight: bold;padding-right: 80px;" >Buyers Login</a>
                    </li>
					<li>
	 ...
	 <p align = "center"style = "color: #fff;">A commercial platform to expand the customer scale for farmers and ease purchase for buyers online.</p>
	  ...
	  <form method = "post" action = "searchresult.php" style = "width: 45%; margin: auto;">
			<input type = "text" name = "searchvalue" placeholder="What do you need?" maxlength="20" style="margin-left: 80px;width: 300px; padding:7px; border:1px solid blue; border-radius-top-left: 5px;border-radius-bottom-left: 5px; " required>
	 ...
	 <h1 align ="center" ><strong> Explore Our MarKetPlace</strong></h1><br/><br/>
		<?php
			...
			<div class = "thumbnail" align = "center">
				...
				<a href = "login.php"><span class = "hint"><strong>Click to Buy </strong></span><img class = "img-responsive"
				<?php
