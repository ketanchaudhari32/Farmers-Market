        ...
        <div class="container">
            ...
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                    ...
                    <span class="icon-bar"></span>
                    <span class="icon-bar"></span>
                </button> <a class="navbar-brand" href="index.php" style = "padding-right = 45px; "><strong>Farmer's Basket</strong></a>
            </div>
  ...
  <div class = "thumbnail" style="width: 65%; margin:auto;">
        ...
        if (isset($_POST['category']) && (isset($_POST['email'])) && (isset($_POST['username'])) && (!empty($_POST['password']))) {
			...
			<p style='padding-left:5px; margin-bottom: 0px;color: #808080;'>Please select category</p>
			 <div name = "select-cat" style= "padding-right: 50px; color: #808080;">
				<input name = "category" type= "radio" <?php if (isset($category) && $category=="buyer") {
                echo "checked";
            }?> value= "buyer">Buyer
				<input name = "category" type ="radio" <?php if (isset($category) && $category=="farmer") {
                echo "checked";
            }?> value = "farmer">Farmer
			 </div>
	...
	<div style = "padding: 1em 0 2em 0;">
		...
		<footer id="footer" class="container" style ="background: #fff; color: black; width: 100%; ">
										...
										<p align = "center">Farmers's Basket</p>
